...
export function LoginForm() {
    ...
    return (
        ...
        >
            ...
            <Form.Submit asChild>
                <button className="mt-2 box-border inline-flex h-8 w-full items-center justify-center bg-white leading-none font-medium text-black hover:border hover:border-white hover:bg-black hover:text-white focus:bg-black focus:text-white focus:shadow-[0_0_0_2px]">
                    Sign in
                </button>
            </Form.Submit>
