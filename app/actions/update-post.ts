...
export async function updatePost(
    ...
    const existingPost = await PostsDatabaseAPI.findBySlugPublic(slug)
    if (!existingPost) {
        return {
            success: false,
    ...
    const conflictingPost = await PostsDatabaseAPI.findBySlugPublic(
    ...
    try {
        await PostsDatabaseAPI.updatePost(slug, parsedData.data)
